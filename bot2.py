...
stopuser = {}
token = '7679284056:AAHhvy8-dXEeXILGT78DurPrLiUqk3tx6z4'
...
''',reply_markup=keyboard)
		...
		sw3 = types.InlineKeyboardButton(text=f" HQ Charge 10$ 💥",callback_data='au')
		keyboard.add(contact_button)
		keyboard.add(sw)
		keyboard.add(sw1)
		keyboard.add(sw2)
...
𝙏𝙞𝙢𝙚 ➼ {"{:.1f}".format(execution_time)}
𝗕𝗼𝘁 𝗕𝘆: chk1212</b>'''
					if "insufficient_funds" in last or 'succeeded' in last or 'Thank You For Your Support!' in last or 'next_source_action' in last or 'thank-you-for-your-support' in last or 'thank you' in last:
						live += 1
						bot.send_message(call.from_user.id, msg)
					elif 'risk' in last:
						risk+=1
